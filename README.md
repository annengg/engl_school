...
13. **Лицензирование и права на контент**
   ...
   +-------------------+      +-------------------+      +--------------------+
   |  Пользователи     |      |     Платформа     |      |     Сервисы        |
   |  (Студенты,       |      |     LMS (Learning |      |                    |
   |  Преподаватели,   | ---> |     Management    | ---> |  - База данных     |
   |  Администраторы)  |      |     System)       |      |  - Платежная система|
   +-------------------+      +-------------------+      |  - API             |
                            /|\                         +--------------------+
                             |
                             |
   +--------------------+    |    +---------------------+
   |   Безопасность     | <---->  |   Мониторинг и       |
   |  (Аутентификация,  |         |   Журналирование     |
   |  Шифрование,       |         |   (SIEM-система)     |
   |  Защита данных)    |         +---------------------+
   +--------------------+       
